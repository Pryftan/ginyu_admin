...
const matchesAll = [
  [['Chris', 'Javier', 'Sasha', 'Coleman'], ['Aamer', 'Chris', 'Javier', 'Sasha'], ['Aamer', 'Billy', 'Chris', 'Sasha'], ['Billy', 'Javier', 'Kirk', 'Sasha'], ['Aamer', 'Javier', 'Kirk', 'Coleman'], ['Billy', 'Kirk', 'Sasha', 'Coleman'], ['Aamer', 'Chris', 'Kirk', 'Coleman'], ['Aamer', 'Billy', 'Chris', 'Coleman'], ['Billy', 'Chris', 'Javier', 'Kirk'], ['Aamer', 'Billy', 'Sasha', 'Coleman'], ['Chris', 'Kirk', 'Sasha', 'Coleman'], ['Aamer', 'Billy', 'Javier', 'Kirk'], ['Aamer', 'Billy', 'Chris', 'Javier'], ['Javier', 'Kirk', 'Sasha', 'Coleman']],
