...
const matchesAll = [
  [['Aamer', 'Billy', 'Sasha', 'Kirk'], ['Aamer', 'Sasha', 'Coleman', 'Javier'], ['Sasha', 'Coleman', 'Javier', 'Kirk'], ['Aamer', 'Billy', 'Coleman', 'Javier'], ['Aamer', 'Billy', 'Javier', 'Kirk'], ['Aamer', 'Sasha', 'Coleman', 'Kirk'], ['Aamer', 'Sasha', 'Javier', 'Kirk'], ['Billy', 'Coleman', 'Javier', 'Kirk'], ['Billy', 'Sasha', 'Coleman', 'Javier'], ['Aamer', 'Billy', 'Coleman', 'Kirk'], ['Aamer', 'Billy', 'Sasha', 'Coleman'], ['Billy', 'Sasha', 'Javier', 'Kirk']],
  [['Aamer', 'Sasha', 'Coleman', 'Javier'], ['Aamer', 'Billy', 'Javier', 'Kirk'], ['Aamer', 'Billy', 'Sasha', 'Kirk'], ['Billy', 'Sasha', 'Coleman', 'Kirk'], ['Aamer', 'Coleman', 'Javier', 'Kirk'], ['Aamer', 'Billy', 'Sasha', 'Coleman'], ['Billy', 'Coleman', 'Javier', 'Kirk'], ['Aamer', 'Sasha', 'Javier', 'Kirk'], ['Aamer', 'Billy', 'Coleman', 'Kirk'], ['Billy', 'Sasha', 'Coleman', 'Javier'], ['Aamer', 'Billy', 'Sasha', 'Javier'], ['Sasha', 'Coleman', 'Javier', 'Kirk'], ['Aamer', 'Coleman', 'Sasha', 'Kirk'], ['Javier', 'Kirk', 'Billy', 'Coleman'], ['Billy', 'Sasha', 'Javier', 'Aamer']],
  [['Aamer', 'Chris', 'Coleman', 'Javier'], ['Aamer', 'Billy', 'Coleman', 'Kirk'], ['Aamer', 'Chris', 'Javier', 'Kirk'], ['Billy', 'Chris', 'Coleman', 'Kirk'], ['Aamer', 'Billy', 'Chris', 'Javier'], ['Aamer', 'Coleman', 'Javier', 'Kirk'], ['Chris', 'Coleman', 'Javier', 'Kirk'], ['Aamer', 'Billy', 'Chris', 'Kirk'], ['Aamer', 'Billy', 'Coleman', 'Javier'], ['Billy', 'Chris', 'Javier', 'Kirk'], ['Billy', 'Coleman', 'Javier', 'Kirk'], ['Aamer', 'Billy', 'Chris', 'Coleman']],
  [['Aamer', 'Javier', 'Kirk', 'Coleman'], ['Aamer', 'Billy', 'Javier', 'Coleman'], ['Billy', 'Javier', 'Kirk', 'Coleman'], ['Aamer', 'Billy', 'Javier', 'Kirk'], ['Aamer', 'Chris', 'Kirk', 'Coleman'], ['Aamer', 'Billy', 'Chris', 'Javier'], ['Chris', 'Javier', 'Kirk', 'Coleman'], ['Aamer', 'Billy', 'Chris', 'Coleman'], ['Aamer', 'Chris', 'Javier', 'Kirk'], ['Billy', 'Chris', 'Kirk', 'Coleman'], ['Aamer', 'Billy', 'Chris', 'Kirk'], ['Billy', 'Chris', 'Javier', 'Coleman']],
