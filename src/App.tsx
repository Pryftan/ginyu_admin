...
const matchesAll = [
  [['Aamer', 'Sasha', 'Coleman', 'Javier'], ['Aamer', 'Billy', 'Javier', 'Kirk'], ['Aamer', 'Billy', 'Sasha', 'Kirk'], ['Billy', 'Sasha', 'Coleman', 'Kirk'], ['Aamer', 'Coleman', 'Javier', 'Kirk'], ['Aamer', 'Billy', 'Sasha', 'Coleman'], ['Billy', 'Coleman', 'Javier', 'Kirk'], ['Aamer', 'Sasha', 'Javier', 'Kirk'], ['Aamer', 'Billy', 'Coleman', 'Kirk'], ['Billy', 'Sasha', 'Coleman', 'Javier'], ['Aamer', 'Billy', 'Sasha', 'Javier'], ['Sasha', 'Coleman', 'Javier', 'Kirk']],
